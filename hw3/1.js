// Задача 1: Необходимо создать html-страницу с названием 1.html, в которой подключить файл 1.js
...
function convertCtoF(valueC) {
    return Math.floor((valueC * 1.8 + 32) * 100) / 100;
}

const tempC = +prompt('Input a temperature value in Celsius degrees:');
alert(`Celsius: ${tempC}, Fahrenheit: ${convertCtoF(tempC)}`);